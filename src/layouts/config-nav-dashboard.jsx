...
export const navData = [
   ...
   */
  {
    ...
    items: [
      ...
      { title: 'Order History', path: paths.dashboard.general.ecommerce, icon: ICONS.order },
      // { title: 'Users', path: paths.dashboard.general.analytics, icon: ICONS.user },
      { title: 'User', path: paths.dashboard.user.account, icon: ICONS.user },
      {
        title: 'Product',
        path: paths.dashboard.product.root,
        icon: ICONS.product,
        children: [
          { title: 'Residential', path: paths.dashboard.product.root },
          { title: 'Static', path: paths.dashboard.product.demo.details },
